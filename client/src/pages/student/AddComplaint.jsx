...
const AddComplaint = () => {
    ...
    const fetchComplaintTypes = async () => {
      try {
        const res = await axios.get(
          `${import.meta.env.VITE_API_URL}/api/complaint-type`,
        );
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.subject || !formData.complaintType || !formData.description) {
      setMessage({
        type: "error",
        text: "Sabhi fields fill karna zaroori hai.",
      });
      return;
    }
    ...
    try {
      ...
      setMessage({
        type: "success",
        text: "Complaint successfully submit ho gayi! ✅",
      });
      ...
      <div style={styles.formCard}>
        <div style={styles.header}>
          ...
          <p style={styles.subtitle}>
            We are here to help. Tell us what went wrong.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={styles.inputGroup}>
            ...
            <span style={styles.helperText}>
              Select the most relevant department.
            </span>
          </div>
